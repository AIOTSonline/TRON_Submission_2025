...
Blockly.C['lists_length'] = function(block) {
  ...
  return [list + '.length', Blockly.C.ORDER_UNARY_POSTFIX];
};
...
Blockly.C['lists_isEmpty'] = function(block) {
  ...
  var list = Blockly.C.valueToCode(block, 'VALUE',
      Blockly.C.ORDER_UNARY_POSTFIX) || '[]';
  return [list + '.isEmpty', Blockly.C.ORDER_UNARY_POSTFIX];
};
...
Blockly.C['lists_getIndex'] = function(block) {
  ...
  var listOrder = (where == 'RANDOM' || where == 'FROM_END') ?
      Blockly.C.ORDER_NONE : Blockly.C.ORDER_UNARY_POSTFIX;
...
Blockly.C['lists_sort'] = function(block) {
  ...
  var sortFunctionName = Blockly.C.provideFunction_(
      'lists_sort',
      ['List ' + Blockly.C.FUNCTION_NAME_PLACEHOLDER_ +
